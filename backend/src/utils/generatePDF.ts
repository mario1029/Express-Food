...
export const headerPDF= ({pdf, id, amount, email, date}:{pdf:any, id:number, amount:number, email:string, date: string})=>{
    pdf
...
export const tablePDF= ({pdf, detail}:{pdf:any, detail:DetailOrder[]})=>{
    const tableTop = 270
